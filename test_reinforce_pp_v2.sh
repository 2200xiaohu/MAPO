...
project_name='multi_turn_rl_reinforce_pp_v2'
exp_name='qwen2.5_7b_train_max_turns_18_dense_distance_diff_235b_moe_reinforce_pp_v2_final'


adv_estimator=reinforce_plus_plus_multiturn_v2
...
MODEL_PATH="/nas/models/Qwen/Qwen2.5-7B-Instruct"
...
# Run script
cp -r "/nas/naifan/MultiTurnRL/test_reinforce_pp_v2.sh" "${CKPTS_DIR}/code_backup"
...
LOG_FILE="/nas/naifan/MultiTurnRL/reinforce_pp_v2.log"
{
python3 -u -m verl.trainer.main_ppo \
    ...
    #trainer.resume_from_path=/nas/naifan/MultiTurnRL/checkpoints/multi_turn_rl_reinforce_pp_v2/qwen3_8b_train_max_turns_18_dense_distance_diff_235b_moe_reinforce_pp_v2_final/global_step_44 \
