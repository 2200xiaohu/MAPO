...
project_name='multi_turn_rl_reinforce_pp_v4'
exp_name='qwen2.5_7b_train_max_turns_18_dense_distance_diff_235b_moe_reinforce_pp_v4_turn_normalization_final'
...
# Run script
cp -r "/nas/naifan/MultiTurnRL/test_reinforce_pp_v4.sh" "${CKPTS_DIR}/code_backup"
...
# 将日志保存到 reinforce_pp_v4.log
LOG_FILE="/nas/naifan/MultiTurnRL/reinforce_pp_v4.log"
{
python3 -u -m verl.trainer.main_ppo \
    ...
    #trainer.resume_from_path=/nas/naifan/MultiTurnRL/checkpoints/multi_turn_rl_reinforce_pp_v4/qwen3_8b_train_max_turns_18_dense_distance_diff_235b_moe_reinforce_pp_v4_turn_normalization_final/global_step_42 \
