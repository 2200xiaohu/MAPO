...
exp_name='qwen3_8b_train_max_turns_15_dense_distance_diff_235b_moe_reinforce_pp_v5_turn_normalization_batch_normalization_final'
...
# Run script
cp -r "/nas/naifan/MultiTurnRL/test_reinforce_pp_v5_kl.sh" "${CKPTS_DIR}/code_backup"
...
LOG_FILE="/nas/naifan/MultiTurnRL/reinforce_pp_v5_kl_in_reward.log"
{
