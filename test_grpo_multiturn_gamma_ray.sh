...
exp_name='qwen3_32b_grpo_multiturn_gamma_final'
...
# Run script
cp -r "/nas/naifan/MultiTurnRL/test_grpo_multiturn_gamma_ray.sh" "${CKPTS_DIR}/code_backup"
...
LOG_FILE="/nas/naifan/MultiTurnRL/grpo_multiturn_gamma_ray.log"
{
