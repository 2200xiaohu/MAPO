...
cp -f /nas/naifan/MultiTurnRL/MultiTurnRLAgent.py /nas/naifan/verl/verl/interactions/MultiTurnRLAgent.py
cp -r /nas/naifan/MultiTurnRL/MultiTurnDenseRewardManager.py /nas/naifan/verl/verl/workers/reward_manager/MultiTurnDenseRewardManager.py

#ray start --head --dashboard-host=0.0.0.0

#rm -rf /nas/naifan/MultiTurnRL/checkpoints/multi_turn_rl

project_name='exp_test'
exp_name='qwen3_8b_train_max_turns_18_dense_distance_diff_235b_moe_reinforce_pp_multiturn_baseline'


adv_estimator=reinforce_plus_plus_multiturn_baseline
...
# Run script
cp -r "/nas/naifan/MultiTurnRL/test.sh" "${CKPTS_DIR}/code_backup"
...
# 将日志保存到 reinforce.log
LOG_FILE="/nas/naifan/MultiTurnRL/reinforce_pp_multiturn_baseline.log"
{
python3 -u -m verl.trainer.main_ppo \
    ...
    #custom_reward_function.path=/algorithm_nas/algorithm_nas/policy_model/empathy_reward.py \
    #trainer.resume_mode=resume_path \
    #trainer.resume_from_path=/algorithm_nas/algorithm_nas/policy_model/checkpoints/policy_model/32b_policy_model_empathyGenRM_final/global_step_24 \
    # --config-path="$CONFIG_PATH" \
    # --config-name='multiturn_dense_grpo' \
    #+data.apply_chat_template_kwargs.enable_thinking=False \
