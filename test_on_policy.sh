...
project_name='multi_turn_rl'
exp_name='qwen3_8b_train_max_turns_20_dense_distance_diff_235b_moe_on_policy'
...
# Run script
cp -r "/nas/naifan/MultiTurnRL/test_on_policy.sh" "${CKPTS_DIR}/code_backup"
...
# Verl
cp -r "/nas/naifan/verl" "${CKPTS_DIR}/code_backup"
