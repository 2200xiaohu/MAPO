...
project_name='multi_turn_rl_abs_study_adv_weight'
exp_name='qwen2.5_7b_max_turns_15_qwen3_235b_lr_1e-6_batch_adv_0.6_turn_adv_0.4'

adv_estimator=reinforce_plus_plus_multiturn_v5

batch_adv_weight=0.6
turn_adv_weight=0.4
...
# Run script
cp -r "/nas/naifan/MultiTurnRL/test_reinforce_pp_v5.sh" "${CKPTS_DIR}/code_backup"
...
LOG_FILE="/nas/naifan/MultiTurnRL/reinforce_pp_v5_3.log"
{
python3 -u -m verl.trainer.main_ppo \
    ...
    +algorithm.batch_adv_weight=${batch_adv_weight} \
    +algorithm.turn_adv_weight=${turn_adv_weight} \
    \
