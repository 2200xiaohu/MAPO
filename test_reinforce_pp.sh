...
project_name='multi_turn_rl_reinforce_pp'
exp_name='qwen3_8b_train_max_turns_18_dense_distance_diff_235b_moe_reinforce_pp'


adv_estimator=reinforce_plus_plus_multiturn
...
TRAIN_FILE="/nas/naifan/MultiTurnRL/data/train_demo.parquet"
...
LOG_FILE="/nas/naifan/MultiTurnRL/reinforce.log"
{
