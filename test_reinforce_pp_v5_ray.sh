...
exp_name='qwen3_32b_train_max_turns_20_dense_distance_diff_235b_moe_reinforce_pp_v5_turn_normalization_batch_normalization_final_bs32'
...
# Run script
cp -r "/nas/naifan/MultiTurnRL/test_reinforce_pp_v5_ray.sh" "${CKPTS_DIR}/code_backup"
