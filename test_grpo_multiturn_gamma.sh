...
project_name='multi_turn_rl_grpo_multiturn_gamma'
exp_name='qwen2.5_7b_grpo_multiturn_gamma_final'


adv_estimator=grpo_multiturn_gamma
...
# Run script
cp -r "/nas/naifan/MultiTurnRL/test_grpo_multiturn_gamma.sh" "${CKPTS_DIR}/code_backup"
...
# 将日志保存到 grpo_multiturn_gamma.log
LOG_FILE="/nas/naifan/MultiTurnRL/grpo_multiturn_gamma.log"
{
python3 -u -m verl.trainer.main_ppo \
    ...
    #trainer.resume_from_path=/nas/naifan/MultiTurnRL/checkpoints/multi_turn_rl_grpo_multiturn_gamma/qwen3_8b_grpo_multiturn_gamma_final/global_step_46
