...
exp_name='qwen3_8b_train_max_turns_15_dense_distance_diff_235b_moe_reinforce_pp_v4_turn_normalization_on_policy_easy_data'
...
TRAIN_FILE="/nas/naifan/MultiTurnRL/data/train_easy.parquet"
...
# Run script
cp -r "/nas/naifan/MultiTurnRL/test_reinforce_pp_v4_on_policy.sh" "${CKPTS_DIR}/code_backup"
...
LOG_FILE="/nas/naifan/MultiTurnRL/reinforce_pp_v4_on_policy.log"
{
